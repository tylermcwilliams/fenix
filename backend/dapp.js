...
const { master_key, infura_url, airdrop_address } = require("./config/keys.js");
...
const Dapp = {
  ...
  twitterExists: async function(twitterId) {
    return airdropContract.methods._twitter_accounts(twitterId);
  },
  ethExists: async function(ethAddress) {
    return airdropContract.methods._eth_addresses(ethAddress);
  }
};
